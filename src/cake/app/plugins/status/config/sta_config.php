...
Configure::write('StatusBehavior.options.display_level', array('field' => 'display_level', 'options' => array('general', 'fact_site', 'private'), 'active' => array('general', 'fact_site', 'private'), 'default' => 'general'));
